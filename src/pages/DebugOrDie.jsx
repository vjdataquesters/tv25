      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="mb-10">
          ...
          <div className="mt-4">
            <p className="text-gray-200 text-lg leading-relaxed p-4 text-justify">
              ...
              , racing against the clock to crack codes, solve puzzles, and debug their way out of a simulated lab lockdown. This event tests both{" "}
              <span className="text-yellow-300 font-semibold bg-yellow-300/20 px-2 py-1 rounded-lg">
                technical skills
              </span>{" "}
              and{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6 text-center">
            ...
            <p className="text-gray-200 text-lg font-bold">10:00 AM – 4:30 PM</p>
          </div>
          <div className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6 text-center">
            <div className="text-4xl mb-3">💰</div>
            <p className="text-yellow-300 font-semibold mb-2 text-xl">Prize Pool</p>
        ...
        <div className="mb-12 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/10 transition-all duration-300">
          ...
          <div className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6 text-center">
            <p className="text-yellow-300 font-bold text-2xl">Critical Thinking Challenge</p>
            <p className="text-gray-300 mt-2">Escape-room-style tech challenge</p>
          </div>
        </div>
        ...
        <div className="mb-12 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/10 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6">
              ...
              <p className="text-gray-200 text-2xl font-bold">3-4 members per team</p>
            </div>
            <div className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6">
              <div className="flex items-center mb-3">
                <span className="text-2xl mr-3">🎫</span>
              ...
              <p className="text-gray-200 text-lg">All participants must hold a Technovista Pass</p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                number: "1",
                title: "Registration",
                description: "A Google Form will be released for team registrations. Teams must register with accurate member information."
              },
              {
                number: "2",
                title: "WhatsApp Group Addition",
                description: "All registered teams will be added to an official WhatsApp group for event-related updates."
              },
              {
                number: "3",
                title: "Event Day Execution",
                description: "Each team will be allotted a time slot on 1st August 2025. Teams participate in their allotted slot to solve the challenge."
              }
            ].map((step, index) => (
              <div key={index} className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-yellow-300 font-semibold mb-2 text-lg">{step.title}</h4>
          ...
          <div className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6">
            <ul className="space-y-3 text-gray-200">
              <li className="flex items-start">
                ...
                <span>Teams will be monitored while solving the challenge</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-300 mr-2 mt-1">•</span>
              ...
              <li className="flex items-start">
                <span className="text-yellow-300 mr-2 mt-1">•</span>
                <span>The team that completes the challenge in the shortest time wins</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-12 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/10 transition-all duration-300">
          ...
          <div className="bg-gradient-to-br from-yellow-600/10 to-yellow-400/5 backdrop-blur-lg border border-yellow-400/20 rounded-xl p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-yellow-300 font-semibold text-lg">WhatsApp Group</p>
                <p className="text-gray-300">All registered participants will be added to a WhatsApp group for official communications.</p>
              </div>
            </div>
          </div>
        </div>
