                    ...
                    <div>
                        ...
                        <input
                            {...register("collegeName", {
                                required: watch("college") === "Other" ? "College name is required" : false
                            })}
                            ...
                            {...register("rollno", {
                                ...
                                validate: (value) => {
                                    ...
                                    if (selectedCollege === "VNRVJIET") {
                                        const isValid = /^[0-9]{2}(071A|075A)[0-9]{2}([0-9]{2}|[A-Za-z][0-9]|[0-9][A-Za-z])$/.test(value);
                                        return (isValid && value.length === 10) || "Enter a valid roll number";
                                    }
                                    return true;
                                }
                            })}
